...
public interface VeterinarioMapper {
    ...
    @Mapping(target = "idEspecialidad", source = "veterinario.especialidad.idEspecialidad")
    @Mapping(target = "celular", source = "veterinario.persona.celular")
    @Mapping(target = "fotoUrl", source = "veterinario.persona.fotoUrl")
    @Mapping(target = "activo", source = "veterinario.persona.activo")
    @Mapping(target = "genero", source = "veterinario.persona.genero")
